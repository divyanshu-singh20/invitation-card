...
const SellerForgotPasswordPage = () => {
  ...
  const handleResetPassword = async (e) => {
    ...
    try {
      const response = await api.post('/sellers/forgot-password/reset-with-otp', {
        email,
        otp,
        newPassword
      });
            ...
            <form onSubmit={handleSendOTP} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-5 py-4 bg-gray-100 text-gray-900 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 transition-all duration-200"
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white font-bold py-4 rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
              >
                {loading ? (
              ...
              <div className="pt-4 text-center">
                <Link to="/seller/login" className="text-sm text-orange-600 hover:text-orange-700 font-medium">
                  ← Back to Login
                </Link>
              </div>
            </form>
            ...
            <form onSubmit={handleResetPassword} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  required
                  maxLength="6"
                  className="w-full px-5 py-4 bg-gray-100 text-gray-900 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 transition-all duration-200 text-center text-2xl tracking-widest font-semibold"
                  placeholder="000000"
                />
